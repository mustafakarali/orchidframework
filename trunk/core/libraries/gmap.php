...
/**
 * Renamed as GMap for Orchid , 22nd Dec 2007
 * Also Modified the constructor a bit to API key from Config $config['google_map_api'];
 *
 */
...
*/
     ...
     * Added By Hasin Hayder, 22nd Dec 2007
     */
	private $mapType="map";
 ...
 */
	...
	public Function getGeoCode($address)
	{
		...
		if($_result = file_get_contents($_url)) {
			...
			$lon = $_match[2];
			$lat = $_match[1];
			return array("lat"=>$lat,"lon"=>$lon,"address"=>$address);
		}
		else 
		return false;
	}
